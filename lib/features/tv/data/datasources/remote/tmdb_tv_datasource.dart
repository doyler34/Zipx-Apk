...
class TmdbTvDatasource {
  ...
  /// narrows further (e.g. Action & Adventure, Drama) for the Anime home's
  /// genre rows; [sortBy]/[minVoteCount] drive the Popular/New/Top Rated row
  /// variants.
  Future<TvResultModel> discoverAnimeTv({
    int page = 1,
